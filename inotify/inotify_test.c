...
int main(int argc, char *argv[])
{
    ...
    if ((inotify_fd = open_inotify_fd()) > 0) {
         ...
         * files passed in as arguments.Read the article for why you 
         * might want to alter this for more efficient inotify use in your 
         * app.      
         */
        int index;
        wd = 0;
        ...
        if (wd > 0) {
            /* 
             * Wait for events and process them until a termination condition 
             * is detected 
             */
